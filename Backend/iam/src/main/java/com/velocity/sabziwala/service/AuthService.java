...
public class AuthService {
	...
	public AuthResponse login(@Valid LoginRequest request){
		...
		// Step 1 : Spring Security authentication (throws BadCredentialsException on failure)
	...
	public AuthResponse refreshToken(@Valid RefreshTokenRequest request) {
        ...
        if (storedToken.isExpired()) {
            ...
            redisTokenService.removeCachedRefreshToken(
                    storedToken.getUser().getUserId().toString());
        ...
        // Update Redis cache
        redisTokenService.cacheRefreshToken(
